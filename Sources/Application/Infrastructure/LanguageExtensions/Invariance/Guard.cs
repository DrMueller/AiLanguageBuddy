...
using Mmu.AiLanguageBuddy.Infrastructure.LanguageExtensions.Invariance.Servants;

namespace Mmu.AiLanguageBuddy.Infrastructure.LanguageExtensions.Invariance
{
    [PublicAPI]
